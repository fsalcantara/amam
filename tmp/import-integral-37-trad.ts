...
const product = {
  ...
  "description": "Pão de forma com 37% de composição integral, com textura macia e sabor equilibrado para o dia a dia.",
  "highlights": "",
  ...
  "containsGluten": true,
  "image": "/SITE/PRODUTOS/LINHA INTEGRAL/integral-37-tradicional.png",
  "nutritionalInfo": {
    "servingSize": 50,
    "servingsPerPack": 7,
    "nutrients": {
...
async function run() {
  try {
    ...
    if (existing) {
      ...
      console.log('✅ Integral 37% Tradicional atualizado!');
    } else {
      ...
      console.log('✅ Integral 37% Tradicional inserido!');
    }
    process.exit(0);
  } catch (err) {
