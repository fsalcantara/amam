...
const product = {
  ...
  "slug": "pao-de-forma-integral-37-sem-casca",
  "description": "Pão de forma integral sem casca, com 37% de composição integral, textura macia e sabor equilibrado.",
  "highlights": "",
  "category": "sem-casca",
...
async function run() {
  try {
    ...
    if (existing) {
      ...
      console.log('✅ Produto Integral 37% atualizado no SQLite!');
    } else {
      ...
      console.log('✅ Produto Integral 37% inserido no SQLite!');
    }
    process.exit(0);
  } catch (err) {
